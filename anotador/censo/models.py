...
class Familia(models.Model):
    ...
    establecimientoEducativo = models.ForeignKey(Institucion, models.CASCADE, related_name="famEstEduc",  blank=True, null=True, limit_choices_to={'esEducativa': True})
    centroFormacion = models.ForeignKey(Institucion, models.CASCADE, related_name="famEstForm", blank=True, null=True, limit_choices_to={'esCentroFormacion': True})
    establecimientoCuidados = models.ForeignKey(Institucion, models.CASCADE, related_name="famEstCuida", blank=True, null=True, limit_choices_to={'esCuidados': True})
